...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/AIon-C/AIon-Copilot/backend/gen/go/chatapp/user/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	UserServiceName = "chatapp.user.v1.UserService"
)
...
const (
	...
	UserServiceGetMeProcedure = "/chatapp.user.v1.UserService/GetMe"
	// UserServiceUpdateProfileProcedure is the fully-qualified name of the UserService's UpdateProfile
	// RPC.
	UserServiceUpdateProfileProcedure = "/chatapp.user.v1.UserService/UpdateProfile"
	// UserServiceChangePasswordProcedure is the fully-qualified name of the UserService's
	// ChangePassword RPC.
	UserServiceChangePasswordProcedure = "/chatapp.user.v1.UserService/ChangePassword"
)

// UserServiceClient is a client for the chatapp.user.v1.UserService service.
...
// NewUserServiceClient constructs a client for the chatapp.user.v1.UserService service. By default,
...
func NewUserServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) UserServiceClient {
	...
	userServiceMethods := v1.File_chatapp_user_v1_user_service_proto.Services().ByName("UserService").Methods()
...
// GetMe calls chatapp.user.v1.UserService.GetMe.
...
// UpdateProfile calls chatapp.user.v1.UserService.UpdateProfile.
...
// ChangePassword calls chatapp.user.v1.UserService.ChangePassword.
...
// UserServiceHandler is an implementation of the chatapp.user.v1.UserService service.
...
func NewUserServiceHandler(svc UserServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/chatapp.user.v1.UserService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedUserServiceHandler) GetMe(context.Context, *v1.GetMeRequest) (*v1.GetMeResponse, error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("chatapp.user.v1.UserService.GetMe is not implemented"))
}
...
func (UnimplementedUserServiceHandler) UpdateProfile(context.Context, *v1.UpdateProfileRequest) (*v1.UpdateProfileResponse, error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("chatapp.user.v1.UserService.UpdateProfile is not implemented"))
}
...
func (UnimplementedUserServiceHandler) ChangePassword(context.Context, *v1.ChangePasswordRequest) (*v1.ChangePasswordResponse, error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("chatapp.user.v1.UserService.ChangePassword is not implemented"))
}
